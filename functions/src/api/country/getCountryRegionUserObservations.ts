...
const getCountryRegionUserObservations = async (
  request: Request,
  response: Response
  ...
  try {
    ...
    observationsQuery = observationsQuery.where('region', '==', request.params.regionId)
...
export default getCountryRegionUserObservations
