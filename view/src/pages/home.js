  ...
  return (
    <>
      ...
      >
        ...
        >
          <span id="blackOverlay" tw="w-full h-full absolute opacity-60 bg-dlolive"></span>
        </div>
        ...
        <div tw="container mx-auto px-4">
            ...
            <div tw="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div tw="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div tw="px-4 py-5 flex-auto">
                  ...
                  <h6 tw="text-xl font-semibold">Put a pin on what you've seen</h6>
            ...
            <div tw="w-full md:w-4/12 px-4 text-center">
              <div tw="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div tw="px-4 py-5 flex-auto">
                  ...
                  <h6 tw="text-xl font-semibold">Who saw most?</h6>
                  <p tw="mt-2 mb-4 text-gray-600">Top 10 lists per country. Or per region of your country.</p>
                </div>
              </div>
            </div>
            ...
            <div tw="pt-6 w-full md:w-4/12 px-4 text-center">
              <div tw="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                <div tw="px-4 py-5 flex-auto">
                  ...
                  <h6 tw="text-xl font-semibold">Find local help</h6>
                  <p tw="mt-2 mb-4 text-gray-600">
          ...
          <div tw="flex flex-wrap items-center mt-32">
            <div tw="w-full md:w-5/12 px-4 mr-auto ml-auto">
              <div tw="text-white p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-dlblue">
                <FontAwesomeIcon icon={faFingerprint} />
              </div>
              <h3 tw="text-3xl mb-2 font-semibold leading-normal">What is this website?</h3>
              ...
              <h4 tw="text-xl mb-2 font-semibold leading-normal">What is this not?</h4>
              <p tw="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700">
                This is not citizen-science. You probably don't want to record every single observation in our database.
                There are better tools for that. See our <Link to="/">list of related services</Link> for those.
              </p>
              {!authUser && (
              ...
              <div tw="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-dlearthy">
                ...
                <blockquote tw="relative p-8 mb-4">
                  ...
                  <p tw="text-base font-light mt-2 text-white">
                    This site was made by some members of Trollslände&shy;föreningen, the Swedish dragonfly society.
                  </p>
                </blockquote>
              </div>
            </div>
