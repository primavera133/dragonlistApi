...
export const PrivacyPolicyPage = ({ history }) => {
  return (
    <Layout>
      <h1>
        <strong>Privacy Policy for Dragonlist</strong>
      </h1>

      <p>
        At Dragonlist, accessible from https://dragonlist.online, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by
        Dragonlist and how we use it.
      </p>

      <p>
        If you have additional questions or require more information about our Privacy Policy, do not hesitate to
        contact us. Our Privacy Policy was created with the help of the{' '}
      ...
      <p>
        Dragonlist follows a standard procedure of using log files. These files log visitors when they visit websites.
      ...
      <p>
        Like any other website, Dragonlist uses 'cookies'. These cookies are used to store information including
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Dragonlist.</p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Dragonlist, which are sent directly to users'
      ...
      <p>
        Note that Dragonlist has no access to or control over these cookies that are used by third-party advertisers.
      </p>

      <h2>Third Party Privacy Policies</h2>

      <p>
        Dragonlist's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>
        ...
        to the information that they shared and/or collect in Dragonlist. This policy is not applicable to any
